...
class Zip:
            ...
            if Source.is_dir():
                for foldername, subfolders, filenames in os.walk(Source):
                    for filename in filenames:
                        ...
                        zipf.write(file_path, arcname=file_path.relative_to(Source.parent))
            else:
    ...
    async def list_contents(self, archive_file: Path) -> str:
        try:
            ...
            content_table = Table(show_lines=True, title="[accent]ARCHIVE CONTENT", border_style='borders')
        ...
        try:
            with zipfile.ZipFile(zip_file, 'r') as zf:
                for file in zf.infolist():
                    ...
                    content_table.add_row(file.filename, file_type, SizeHelper(file.file_size))
