...
_PARAMSPEC_TYPES: tuple[type[typing_extensions.ParamSpec], ...] = (
...
def is_classvar(tp: Any, /) -> bool:
    ...
    return _is_typing_name(tp, name="ClassVar") or _is_typing_name(
        get_origin(tp), name="ClassVar"
    )
...
def is_classvar_annotation(tp: Any, /) -> bool:
    ...
    if (
        is_classvar(tp)
        or (anntp := annotated_type(tp)) is not None
        and is_classvar(anntp)
    ):
        return True
...
def is_finalvar(tp: Any, /) -> bool:
    ...
    return _is_typing_name(tp, name="Final") or _is_typing_name(
        get_origin(tp), name="Final"
    )
...
_DEPRECATED_TYPES: tuple[type[typing_extensions.deprecated], ...] = (
