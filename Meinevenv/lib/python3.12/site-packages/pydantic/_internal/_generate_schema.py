...
from typing import (TYPE_CHECKING, Any, Callable, Dict, Final, ForwardRef,
                    Iterable, Iterator, Mapping, Type, TypeVar, Union, cast,
                    overload)
...
from pydantic_core import (CoreSchema, MultiHostUrl, PydanticCustomError,
                           ...
                           to_jsonable_python)
from typing_extensions import (Literal, TypeAliasType, TypedDict, get_args,
...
from . import (_core_utils, _decorators, _discriminated_union,
               _known_annotated_metadata, _typing_extra)
from ._config import ConfigWrapper, ConfigWrapperStack
from ._core_metadata import update_core_metadata
from ._core_utils import (collect_invalid_schemas,
                          define_expected_missing_refs, get_ref, get_type_ref,
                          is_function_with_inner_schema,
                          is_list_like_schema_with_items_schema,
                          simplify_schema_references, validate_core_schema)
...
from ._generics import (get_standard_typevars_map, has_instance_in_type,
                        recursively_defined_type_refs, replace_types)
...
class GenerateSchema:
    ...
    def _model_schema(self, cls: type[BaseModel]) -> core_schema.CoreSchema:
        ...
        with self.defs.get_schema_or_ref(cls) as (model_ref, maybe_schema):
            ...
            with self._config_wrapper_stack.push(
                config_wrapper
    ...
    def _generate_schema_from_property(
        ...
        if (
            ...
            and (existing_schema := obj.__dict__.get("__pydantic_core_schema__"))
            is not None
    ...
    def _common_field_schema(  # C901
        ...
        if not field_info.evaluated:
            ...
            try:
                evaluated_type = _typing_extra.eval_type(
                    field_info.annotation, *self._types_namespace
                )
            except NameError as e:
                raise PydanticUndefinedAnnotation.from_name_error(e) from e
            ...
            if not has_instance_in_type(evaluated_type, PydanticRecursiveRef):
                ...
                for k, v in new_field_info._attributes_set.items():
                    ...
                    if (
                        k not in field_info._attributes_set
                        and k not in field_info.metadata_lookup
                    ):
    ...
    def _apply_field_serializers(
        ...
        if serializers:
            ...
            try:
                ...
                return_type = _decorators.get_function_return_type(
                    serializer.func,
                    serializer.info.return_type,
                    localns=self._types_namespace.locals,
                )
            except NameError as e:
                raise PydanticUndefinedAnnotation.from_name_error(e) from e
