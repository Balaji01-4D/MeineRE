...
from typing import (TYPE_CHECKING, Any, Callable, Counter, Dict, Hashable,
                    Iterable, NewType, Pattern, Sequence, Tuple, TypeVar,
                    Union, cast, overload)
...
from ._internal import (_config, _core_metadata, _core_utils, _decorators,
                        ...
                        _schema_generation_shared, _typing_extra)
...
class GenerateJsonSchema:
    ...
    def dict_schema(self, schema: core_schema.DictSchema) -> JsonSchemaValue:
        ...
        if (
            values_schema or keys_pattern is not None
        ):  # don't add additionalProperties if it's empty
