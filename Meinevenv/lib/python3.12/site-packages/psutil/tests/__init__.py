...
import psutil
from psutil import AIX, LINUX, MACOS, NETBSD, OPENBSD, POSIX, SUNOS, WINDOWS
from psutil._common import (bytes2human, debug, memoize, print_color,
                            supports_ipv6)
from psutil._compat import (PY3, FileExistsError, FileNotFoundError, range,
                            super, unicode, which)
