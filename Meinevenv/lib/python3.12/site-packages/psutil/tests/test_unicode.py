...
import psutil
from psutil import BSD, MACOS, POSIX, WINDOWS
from psutil._compat import PY3, super
from psutil.tests import (APPVEYOR, ASCII_FS, CI_TESTING, HAS_ENVIRON,
                          HAS_MEMORY_MAPS, HAS_NET_CONNECTIONS_UNIX,
                          INVALID_UNICODE_SUFFIX, PYPY, TESTFN_PREFIX,
                          UNICODE_SUFFIX, PsutilTestCase, bind_unix_socket,
                          chdir, copyload_shared_lib, create_py_exe,
                          get_testfn, pytest, safe_mkdir, safe_rmpath,
