...
from ._common import (AIX, BSD, CONN_CLOSE, CONN_CLOSE_WAIT, CONN_CLOSING,
                      CONN_ESTABLISHED, CONN_FIN_WAIT1, CONN_FIN_WAIT2,
                      CONN_LAST_ACK, CONN_LISTEN, CONN_NONE, CONN_SYN_RECV,
                      CONN_SYN_SENT, CONN_TIME_WAIT, LINUX, MACOS,
                      NIC_DUPLEX_FULL, NIC_DUPLEX_HALF, NIC_DUPLEX_UNKNOWN,
                      POWER_TIME_UNKNOWN, POWER_TIME_UNLIMITED, STATUS_DEAD,
                      STATUS_DISK_SLEEP, STATUS_IDLE, STATUS_LOCKED,
                      STATUS_PARKED, STATUS_RUNNING, STATUS_SLEEPING,
                      STATUS_STOPPED, STATUS_TRACING_STOP, STATUS_WAITING,
                      STATUS_WAKING, STATUS_ZOMBIE, SUNOS, WINDOWS,
                      AccessDenied, Error, NoSuchProcess, TimeoutExpired,
                      ZombieProcess, debug, memoize_when_activated)
from ._common import wrap_numbers as _wrap_numbers
from ._compat import PY3 as _PY3
from ._compat import PermissionError, ProcessLookupError
