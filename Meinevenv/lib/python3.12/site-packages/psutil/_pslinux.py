...
from . import _common, _psposix
from . import _psutil_linux as cext
from . import _psutil_posix as cext_posix
from ._common import (NIC_DUPLEX_FULL, NIC_DUPLEX_HALF, NIC_DUPLEX_UNKNOWN,
                      AccessDenied, NoSuchProcess, ZombieProcess, bcat, cat,
                      debug, decode, get_procfs_path, isfile_strict, memoize,
                      memoize_when_activated, open_binary, open_text,
                      parse_environ_block, path_exists_strict, supports_ipv6,
                      usage_percent)
from ._compat import (PY3, FileNotFoundError, PermissionError,
                      ProcessLookupError, b, basestring)
    ...
    * https://github.com/famzah/linux-memavailable-procfs/issues/2
    ...
    try:
        ...
        debug(
            ...
            "calculating available memory" % err.args[0]
        )
        return fallback
    try:
    ...
    def cpu_freq():
        ...
        for i, path in enumerate(paths):
            ...
            if curr is None:
                ...
                if curr is None:
                    online_path = "/sys/devices/system/cpu/cpu{}/online".format(i)
