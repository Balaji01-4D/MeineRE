...
class GUID(ctypes.Structure):
    ...
    def __init__(
        self, data1: int, data2: int, data3: int, data4: Tuple[int], *args, **kwargs
    ):
        super().__init__(*args, **kwargs)
...
class IShellItemVtbl(ctypes.Structure):
    _fields_ = [
        (
            "QueryInterface",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIShellItem, REFIID, LPVOIDP),
        ),
        ...
        (
            "BindToHandler",
            ctypes.WINFUNCTYPE(
                ctypes.HRESULT, LPIShellItem, LPIBindCtx, REFGUID, REFIID, LPVOIDP
            ),
        ),
        ("GetParent", ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIShellItem, LPLPIShellItem)),
        (
            "GetDisplayName",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIShellItem, SIGDN, LPLPOLESTR),
        ),
        (
            "GetAttributes",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIShellItem, SFGAOF, LPSFGAOF),
        ),
        (
            "Compare",
            ctypes.WINFUNCTYPE(
...
IShellItem._fields_ = [("lpVtbl", ctypes.POINTER(IShellItemVtbl))]


# Multiple shell item class
class IShellItemArray(ctypes.Structure):
    pass
...
class IShellItemArrayVtbl(ctypes.Structure):
    _fields_ = [
        (
            "QueryInterface",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIShellItemArray, REFIID, LPVOIDP),
        ),
        ...
        (
            "BindToHandler",
            ctypes.WINFUNCTYPE(
                ctypes.HRESULT, LPIShellItemArray, LPIBindCtx, REFGUID, REFIID, LPVOIDP
            ),
        ),
        (
            "GetPropertyStore",
            ctypes.WINFUNCTYPE(
                ctypes.HRESULT, LPIShellItemArray, ctypes.c_int, REFIID, LPVOIDP
            ),
        ),
        (
            "GetPropertyDescriptionList",
            ctypes.WINFUNCTYPE(
                ctypes.HRESULT, LPIShellItemArray, ctypes.c_void_p, REFIID, LPVOIDP
            ),
        ),
        (
            "GetAttributes",
            ctypes.WINFUNCTYPE(
                ctypes.HRESULT, LPIShellItemArray, SIATTRIBFLAGS, SFGAOF, LPSFGAOF
            ),
        ),
        ...
        (
            "GetItemAt",
            ctypes.WINFUNCTYPE(
                ctypes.HRESULT, LPIShellItemArray, DWORD, LPLPIShellItem
            ),
        ),
...
IShellItemArray._fields_ = [("lpVtbl", ctypes.POINTER(IShellItemArrayVtbl))]
...
class IFileOpenDialogVtbl(ctypes.Structure):
    _fields_ = [
        (
            "QueryInterface",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, REFIID, LPVOIDP),
        ),
        ...
        (
            "SetFileTypes",
            ctypes.WINFUNCTYPE(
                ctypes.HRESULT, LPIFileOpenDialog, UINT, LPTCLCOMDLG_FILTERSPEC
            ),
        ),
        (
            "SetFileTypeIndex",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, UINT),
        ),
        (
            "GetFileTypeIndex",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPUINT),
        ),
        (
            "Advise",
            ctypes.WINFUNCTYPE(
                ctypes.HRESULT, LPIFileOpenDialog, ctypes.c_void_p, LPDWORD
            ),
        ),
        ...
        (
            "SetOptions",
            ctypes.WINFUNCTYPE(
                ctypes.HRESULT, LPIFileOpenDialog, FILEOPENDIALOGOPTIONS
            ),
        ),
        (
            "GetOptions",
            ctypes.WINFUNCTYPE(
                ctypes.HRESULT, LPIFileOpenDialog, LPFILEOPENDIALOGOPTIONS
            ),
        ),
        (
            "SetDefaultFolder",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPIShellItem),
        ),
        (
            "SetFolder",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPIShellItem),
        ...
        (
            "GetFolder",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPLPIShellItem),
        ),
        (
            "GetCurrentSelection",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPLPIShellItem),
        ...
        (
            "GetFileName",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPLPWSTR),
        ),
        ("SetTitle", ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPCWSTR)),
        (
            "SetOkButtonLabel",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPCWSTR),
        ),
        (
            "SetFileNameLabel",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPCWSTR),
        ...
        (
            "AddPlace",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPIShellItem, FDAP),
        ),
        (
            "SetDefaultExtension",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPCWSTR),
        ...
        (
            "Close",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, ctypes.HRESULT),
        ),
        (
            "SetClientGuid",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, REFGUID),
        ),
        ("ClearClientData", ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog)),
        (
            "SetFilter",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, ctypes.c_void_p),
        ),
        (
            "GetResults",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPLPIShellItemArray),
        ),
        (
            "GetSelectedItems",
            ctypes.WINFUNCTYPE(ctypes.HRESULT, LPIFileOpenDialog, LPLPIShellItemArray),
...
IFileOpenDialog._fields_ = [("lpVtbl", ctypes.POINTER(IFileOpenDialogVtbl))]
