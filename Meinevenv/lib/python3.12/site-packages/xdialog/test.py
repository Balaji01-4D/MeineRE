...
def _test():
    ...
    assert (
        len(
            xdialog.open_file(
                "Select a file", [("Text File", "*.txt"), ("Python File", "*.py")]
            )
        )
        > 0
    )
    ...
    assert (
        len(xdialog.save_file("Select a file to save to", [("Text File", "*.txt")])) > 0
    )
    ...
    assert (
        xdialog.yesnocancel("YesNoCancel", "Close This! (If you can't, click Cancel)")
        == xdialog.CANCEL
    )
    ...
    assert (
        xdialog.retrycancel("RetryCancel", "Close This! (If you can't, click Cancel)")
        == xdialog.CANCEL
    )
    ...
    assert (
        xdialog.okcancel("OkCancel", "Close This! (If you can't, click Cancel)")
        == xdialog.CANCEL
    )
