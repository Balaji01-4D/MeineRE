...
from typing import (BinaryIO, ByteString, Callable, ClassVar, Dict, Iterable,
                    Literal, NamedTuple, Optional, TextIO, Tuple, Union,
                    overload)
...
class ZstdDict:
    ...
    def __init__(self, dict_content, is_raw: bool = False) -> None: ...
...
class ZstdCompressor:
    ...
    def compress(self, data, mode: Literal[0, 1, 2] = ...) -> bytes: ...
...
class ZstdDecompressor:
    ...
    def decompress(self, data: ByteString, max_length: int = -1) -> bytes: ...
...
def compress_stream(
    ...
    output_stream: Union[BinaryIO, None],
    *,
    level_or_option: Union[None, int, Dict[CParameter, int]] = None,
    zstd_dict: Union[None, ZstdDict, ZstdDictInfo] = None,
    pledged_input_size: Optional[int] = None,
    read_size: int = 131_072,
    write_size: int = 131_591,
    callback: Optional[Callable[[int, int, memoryview, memoryview], None]] = None,
) -> Tuple[int, int]: ...
...
def train_dict(samples: Iterable, dict_size: int) -> ZstdDict: ...
def finalize_dict(
    zstd_dict: ZstdDict, samples: Iterable, dict_size: int, level: int
) -> ZstdDict: ...
...
class ZstdFile(io.BufferedIOBase):
    ...
    def __init__(
        ...
        mode: str = "r",
        *,
        level_or_option: Union[
            None, int, Dict[CParameter, int], Dict[DParameter, int]
        ] = None,
        zstd_dict: Union[None, ZstdDict, ZstdDictInfo] = None,
        read_size: int = 131_075,
        write_size: int = 131_591,
    ...
    def flush(self, mode: Literal[1, 2] = ...) -> None: ...
...
class SeekableZstdFile(ZstdFile):
    ...
    @staticmethod
    def is_seekable_format_file(
        filename: Union[str, bytes, PathLike, BinaryIO],
    ) -> bool: ...

_BinaryMode = Literal["r", "rb", "w", "wb", "a", "ab", "x", "xb"]  # read  # write
_TextMode = Literal["rt", "wt", "at", "xt"]  # read  # write
