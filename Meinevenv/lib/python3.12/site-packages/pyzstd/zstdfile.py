...
from pyzstd import ZstdCompressor, ZstdFileReader, ZstdFileWriter, _ZSTD_DStreamSizes
...
def open(
    ...
    *,
    ...
    binary_file = ZstdFile(
        filename, zstd_mode, level_or_option=level_or_option, zstd_dict=zstd_dict
    )
