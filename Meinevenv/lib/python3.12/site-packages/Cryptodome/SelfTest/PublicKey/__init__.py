...
from Cryptodome.SelfTest.PublicKey import (test_DSA, test_ECC_Curve448,
                                           test_ECC_Curve25519, test_ECC_Ed448,
                                           test_ECC_Ed25519, test_ECC_NIST,
                                           test_ElGamal, test_import_Curve448,
                                           test_import_Curve25519,
                                           test_import_DSA, test_import_ECC,
                                           test_import_RSA, test_RSA)
