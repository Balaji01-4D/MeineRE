...
from Cryptodome.Math.Primality import (COMPOSITE, PROBABLY_PRIME,
                                       test_probable_prime)
from Cryptodome.PublicKey import (_create_subject_public_key_info,
                                  _expand_subject_public_key_info,
                                  _extract_subject_public_key_info)
from Cryptodome.Util.asn1 import (DerBitString, DerInteger, DerObject,
                                  DerObjectId, DerSequence)
from Cryptodome.Util.py3compat import bchr, bord, iter_range, tobytes, tostr
...
class DsaKey(object):
    ...
    def __init__(self, key_dict):
        ...
        if extra_set and extra_set != set(("x",)):
            raise ValueError(
                "Unknown DSA components = %s" % str(extra_set - set(("x",)))
            )
